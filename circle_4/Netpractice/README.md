...
>>스위치
>>> 2계층 혹은 3계층에서 동작하는 스위치는 패킷 처리에 있어 소프트웨어적으로 처리되는 브릿지와 달리 하드웨어적 동작 방식을 사용하게 때문에 속도가 더 빠르다. 브릿지보다 더 많은 포트를 가질 수 있으며 전송 방식 역시 다양하다. MAC 주소를 학습하는 기능도 있어 이미 통신한 주소에 대해서 효율적인 전송이 가능하다.
