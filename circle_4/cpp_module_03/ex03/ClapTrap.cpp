...
ClapTrap::ClapTrap(void) : name("(no name)_clap_name"), hitPoint(10), energyPoint(10), attackDamage(0)
{
...
ClapTrap::ClapTrap(std::string name) : name(name + "_clap_name"), hitPoint(10), energyPoint(10), attackDamage(0)
{
